jQuery(document).ready(function($) {
	...
	var textinput = jQuery('.mce-content-body').html();
...
/* Bootstrap Tour 
if (window.location.host.indexOf('localhost') == -1&&window.location.host.indexOf('laravel') == -1) {
	$(document).ready(function () {
		var tour = new Tour({

	  steps: [
	  {
	    element: "#ask-question2",
	    title: "Start Asking Questions",
	    content: "Start clearing your doubts in one single click with Winuall!",
	     backdropContainer : ".ask-question26",
	     smartPlacement : true,
	     autoScroll : true
	  ...
	  /*{
	    ...
	    title: "Start Asking Questions",
	    content: "Start clearing your doubts in one single click with Winuall!",
	     backdropContainer : ".ask-question6"
      		
	  },*/
	  /*{
	    element: "#study-material",
	    title: "Browse through Study Materials",
	    content: "Winuall gives you the benefit of viewing study materials from the Experts of Kota ",
	     backdropContainer : ".study-material6"
	  },
	  {
	    element: "#packages",
	    title: "View Questions",
	    content: "Browse the various Packages available from Winuall",
	     backdropContainer : ".packages6"
	  },
	  {
	    element: "#main-content",
	    title: "Follow the Recent Questions, Recently Answered Questions, and Answer Questions with No Responses!",
	    content: "This section lets you stay updated!",
	  ...
	  }/*,
	  {
	    ...
	    content: "Stay Updated",
	     backdropContainer : ".notification6"
	  },
	  {
	    element: "#profile",
	    title: "View Your Profile",
	    content: "Keep all your details updated!",
	     backdropContainer : ".profile6"
      	
	  }
	   {
	    element: "#widget",
	    title: "View Recent Posted Question",
	    backdropContainer : ".widget6",
	    smartPlacement : true,
	    autoScroll : true
	...
	storage: false,//put false to view again and again
  	debug: false,
  	backdrop: true,
  	backdropContainer: 'body',
			...
			template: "<div class='popover tour'><div class='arrow'></div><h3 class='popover-title'></h3><div class='popover-content'></div><div class='popover-navigation'><button class='btn btn-default' data-role='prev'>« Prev</button><span data-role='separator'>&nbsp;</span><button class='btn btn-default' data-role='next'>Next »</button></div><button class='btn btn-default' data-role='end'>End tour</button></div>",
			storage: window.localStorage,//put false to view again and again
			debug: false,
			backdrop: true,
			backdropContainer: 'body',
		});
